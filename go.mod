...
replace github.com/openstack-k8s-operators/keystone-operator/api => github.com/d34dh0r53/keystone-operator/api v0.0.0-20241018131746-aa1c7fb1adbe //allow-merging
